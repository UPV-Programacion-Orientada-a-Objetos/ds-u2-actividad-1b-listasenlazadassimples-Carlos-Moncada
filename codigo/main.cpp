 ...
 * El usuario decide cuántas lecturas desea recolectar (máximo 100)
 */
void leerDesdeArduino(ListaGeneral* listaGestion) {
    ...
    // Pedir al usuario cuántas lecturas desea
    int numLecturas;
    std::cout << "¿Cuántas lecturas desea recolectar? (1-100): ";
    std::cin >> numLecturas;
    
    // Validar el número de lecturas
    if (numLecturas < 1 || numLecturas > 100) {
        std::cout << "❌ Número inválido. Debe estar entre 1 y 100." << std::endl;
        std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
        return;
    }
    
    // Pedir al usuario el puerto
    std::cout << "\nPuertos comunes:" << std::endl;
    ...
    std::cout << "✓ Se recolectarán " << numLecturas << " lecturas válidas\n" << std::endl;
    std::cout << "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n" << std::endl;
    
    std::string linea;
    int lecturasRecibidas = 0;
    
    // Leer hasta alcanzar el número de lecturas especificado por el usuario
    while (lecturasRecibidas < numLecturas) {
        if (puerto.leerLinea(linea)) {
            ...
            if (!(iss >> tipo >> id)) {
                ...
                lecturasRecibidas++;  // Contar también los datos sin formato
                std::cout << "📊 Intentos de lectura: " << lecturasRecibidas << "/" << numLecturas << "\n" << std::endl;
                continue;
            }
            ...
            if (tipo == 'T' || tipo == 't') {
                ...
                if (!(iss >> valor)) {
                    ...
                    lecturasRecibidas++;  // Contar también los valores inválidos
                    std::cout << "📊 Intentos de lectura: " << lecturasRecibidas << "/" << numLecturas << "\n" << std::endl;
                    continue;
                }
                ...
                lecturasRecibidas++;  // Contar también los datos inválidos
                std::cout << "📊 Intentos de lectura: " << lecturasRecibidas << "/" << numLecturas << "\n" << std::endl;
                continue;
            }
            
            lecturasRecibidas++;
            std::cout << "📊 Lecturas válidas recibidas: " << lecturasRecibidas << "/" << numLecturas << "\n" << std::endl;
        }
    }
    ...
    std::cout << "\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" << std::endl;
    std::cout << "✓ Se han recolectado " << numLecturas << " lecturas" << std::endl;
    std::cout << "✓ Conexión cerrada. Regresando al menú principal..." << std::endl;
    std::cout << "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n" << std::endl;
}
